...
%             assert(nofinish,'PlatEMO:Termination',''); 
    ...
    methods(Static, Sealed)
        ...
        % The default output function of ALGORITHM.
            clc; fprintf('%s problem %s run %d on %d-objective %d-variable %s (%6.2f%%), %.2fs passed...\n',class(Algorithm),Problem.str{Problem.problem_id},Problem.number,Problem.M,Problem.D,class(Problem),Problem.FE/Problem.maxFE*100,Algorithm.metric.runtime);
